          ...
          >
            <div className="pointer-events-auto w-full max-w-[880px] max-h-[82vh] rounded-2xl bg-canvas-elevated border border-canvas-border shadow-2xl flex flex-col overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-canvas-border">
                <div>
                  <h2 className="text-[16px] font-semibold text-ink-800">
                  ...
                  {DOMAINS.map((d) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {d.name}
                        <span className="ml-auto text-[12px] text-ink-400 font-normal">
                          {d.tasks.length}
                        </span>
                      </button>
                    );
                    ...
                    {domain.tasks.map((t) => (
                      <li key={t.id}>
                        ...
                        >
                          ...
                          <p className="text-[12px] text-ink-600 italic leading-relaxed line-clamp-2">
                            “{t.basePrompt}”
                          </p>
                        </button>
                      </li>
