            ...
            {workflow.inputs.map((input) => {
              ...
              return (
                ...
                >
                  ...
                  {uploaded > 0 && (
                    <span className="text-[10px] rounded-full bg-white/70 px-1.5 py-0.5 text-compliant-700">
                      {uploaded}
                    </span>
                  )}
                  {input.required && uploaded === 0 && (
                    <span className="text-[9.5px] uppercase tracking-wider font-bold text-risk">
                      Required
                    </span>
                  )}
                </button>
      ...
      <section className="rounded-xl border border-canvas-border bg-canvas-elevated p-4">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10.5px] text-ink-400 rounded-full bg-canvas px-2 py-0.5 border border-canvas-border">
              {totalCount}
            </span>
          </div>
          {activeInput && (
